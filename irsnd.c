...
#  endif // IRSND_OCx
#elif defined (__AVR_AT90CAN128__)                                  // ATmega8515 uses OC0 = PB0 or OC1A = PD5 or OC1B = PE2
...
#			else
        		TCCR2A |= (1<<CS21);                                                      // start Timer 2, prescaler = 8
#			endif
#       else
#     		ifdef TCCR2B
        		TCCR2B |= (1<<CS20);                                                      // start Timer 2, prescaler = 1
#			else
        		TCCR2A |= (1<<CS20);                                                      // start Timer 2, prescaler = 1
#			endif
#       endif
#    elif IRSND_OCx == IRSND_OC0                                                    // use OC0
